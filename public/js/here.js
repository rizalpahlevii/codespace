if (navigator.geolocation) {
    ...
    navigator.geolocation.getCurrentPosition(function(position){
        ...
        function onError(error) {
            alert(`Can\'t reach the remote serve ${error}`);
        }
        ...
        function addRouteShapeToMap(route) {
            ...
            map.addObjects([polyline, routeline, endMarker, startMarker]);
        ...
        function addSummaryToPanel(summary) {
            ...
            const markup = `<div><li>Total Distance: ${
                summary.distance / 1000
            }</li><li>Travel Time: ${summary.travelTime.toMMSS()} (in current traffic)</li></div>`;
        ...
        console.log('GeolocationService: getCurrentPosition() - error code: ' + error.code);
    });
